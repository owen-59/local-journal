...
class FolderSelectionPage extends StatelessWidget {
  ...
  const FolderSelectionPage({super.key, required this.saf, required this.onGranted});
        ...
        child: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              const Text('Access Required', style: TextStyle(fontSize: 22, fontWeight: FontWeight.bold)),
